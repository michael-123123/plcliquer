 ...
 * @file coloring.pl
 * 
 * The naive implementation of graph coloring
 * with max-clique as a pre-processing step
 * **********************************************
...
:- use_module(bee(beeCompiler/bCompiler), [bCompile/2]).
:- use_module(bee(satsolver/satsolver)  , [sat/1]).
:- use_module(bee(beeCompiler/bDecode)  , [decodeIntArray/2]).
:- use_module(cliquer(plcliquer)).
